...
module When
  ...
  class TM::CalendarEra
    ...
    Korean = [self, [
      ...
      [self,
	"period:[高句麗]",
	["[東明王]1",	"@F",	"name=[東明王];-36^Chinese_103"],
	["[瑠璃王]1",	"@A",	"name=[瑠璃王];-18"],
	...
	["[東川王]1",	"@A",	"name=[東川王];227", "239^Chinese0239", ""],
	...
	["[嬰陽王]1",	"@A",	"name=[嬰陽王];590^Chinese0523"],
	["[栄留王]1",	"@A",	"name=[栄留王];618"],
	["[宝臧王]1",	"@A",	"name=[宝臧王];642", "668.09.12="],	# 資治通鑑による、癸巳滅亡
     ],
      [self,
	"period:[百済]",
	["[温祚王]1",	"@F",	"name=[温祚王];-17^Chinese_103"],
	...
	["[古爾王]1",	"@A",	"name=[古爾王];234", "239^Chinese0239", ""],
	...
	["[毗有王]1",	"@A",	"name=[毗有王];427", "451^Chinese0445", ""],
	...
	["[威徳王]1",	"@A",	"name=[威徳王];554", "590^Chinese0523", ""],
	["[恵王]1",	"@A",	  "name=[恵王];598"],
	["[法王]1",	"@A",	  "name=[法王];599"],
	["[武王]1",	"@A",	  "name=[武王];600"],
	["[義慈王]1",	"@A",	"name=[義慈王];641", "660.08="]		# 資治通鑑による
      ...
      [self,
	"period:[新羅]",
	["[赫居世]1",	"@F",	"name=[赫居世];-56^^Chinese_103"],
	...
	["[助賁王]1",	"@A",	"name=[助賁王];230", "239^Chinese0239", ""],
	...
	["[訥祇王]1",	"@A",	"name=[訥祇王];417", "451^Chinese0445", ""],
	...
	["[真平王]1",	"@A",	"name=[真平王];579", "590^Chinese0523", ""],
	...
	["[真聖女王]1",	"@A", "name=[真聖女王];887^ChineseTwin::宣明暦"],	# 東洋史辞典のみ１年遅
	...
	["[敬順王]1",	"@A",	"name=[敬順王];927", "935="],
	  ...
	  ["[慶雲]1",	"@F",	"name=[金憲昌];822^^Chinese0523", "822="]
        ]
      ],
      [self,
	"period:[後百済]",		# 三国遺事による
	["[甄萱]1",	"@F",	"name=[甄萱];900^ChineseTwin::宣明暦", "936.09.08="]
      ],
      [self,
	"period:[後高句麗]",
	["[弓裔]1",	"@F",	"name=[弓裔];901^ChineseTwin::宣明暦"],
	["[摩震]1",	"@A",	"name=[武泰];904"],
	["[聖冊]1",	"",		    "905"],
	...
	["[政開]1",	"",		    "914", "918.06"]
      ...
      [self,
	"period:[高麗]",
	["[天授]1",	"@F",	"name=[太祖];918.06^ChineseTwin::宣明暦"],	# 三国遺事による
	["[太祖]16",	"",		    "933"],
	["[恵宗]1",	"@A",	"name=[恵宗];944"],
	["[定宗]1",	"@A",	"name=[定宗];946"],
	["[光徳]1",	"@A",	"name=[光宗];950"],
	...
	["[忠宣王･再]1","@A",	"name=[忠宣王];1309^Chinese0939"],
