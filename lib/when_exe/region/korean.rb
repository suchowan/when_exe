...
module When
  class TM::CalendarEra
	...
	["[真聖女王]1",	"@A", "name=[真聖女王];887^Chinese::宣明暦"],	# 東洋史辞典のみ１年遅
	...
	["[敬順王]1",	"@A",	"name=[敬順王];927", "935="],
      ...
      [self,
	"period:[後百済]",		# 三国遺事による
	["[甄萱]1",	"@F",	"name=[甄萱];900^Chinese::宣明暦", "936.09.08="]
      ],
      [self,
	"period:[後高句麗]",
	["[弓裔]1",	"@F",	"name=[弓裔];901^Chinese::宣明暦"],
	["[摩震]1",	"@A",	"name=[武泰];904"],
	["[聖冊]1",	"",		    "905"],
	...
	["[政開]1",	"",		    "914", "918.06"]
      ...
      [self,
	"period:[高麗]",
	["[天授]1",	"@F",	"name=[太祖];918.06^Chinese::宣明暦"],	# 三国遺事による
	["[太祖]16",	"",		    "933"],
	["[恵宗]1",	"@A",	"name=[恵宗];944"],
	["[定宗]1",	"@A",	"name=[定宗];946"],
	["[光徳]1",	"@A",	"name=[光宗];950"],
