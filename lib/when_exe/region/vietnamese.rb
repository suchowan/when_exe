...
module When
  ...
  class TM::CalendarEra
	...
	["[応天]1",	"",		     "994",
				"name=[中宗];1005", ""],
	["[景瑞,alias:建瑞]1","@A","name=[臥朝王=zh:%%<黎龍鋌>];1008", "1009="]
      ],
      [self,
	...
	["[天慶=ja:%%<天慶_(陳朝)>,alias:慶天]1","@A","name=[陳暠=zh:%%<陳暠_(越南君主)>];1426.11","1428.01.10="]
      ],
      [self,
	...
	["[洪順]1",	"@A", "name=[襄翼帝=en:Lê_Tương_Dực];1509.12.04"],
	["[光紹]1",	"@A",	"name=[昭宗=en:Lê_Chiêu_Tông];1516.04.27"],
	["[統元]1",	"@A",	"name=[恭帝=en:Lê_Cung_Hoàng];1522.08", "1527.06="],
      ],
      [self,
	...
	["[乾統]1",	"@A",	"name=[代宗=zh:%%<莫敬恭>];1593", "1625="],
	["[隆泰]1",	"@A",	"name=[光祖=zh:%%<莫敬寬>];1618", "1625="],
	["[順徳]1",	"@A",	"name=[明宗=zh:%%<莫敬宇>];1638", "1677="],
      ],
      [self,
	...
	["[阮福瀕=zh:%%<阮福瀕>]0",	"@A",	"name=[太宗];1648.02.27"],
	["[阮福溙=ja:%%<阮福溱>]0",	"@A",	"name=[英宗];1687.03.20"],
	["[阮福淍=ja:%%<阮福淍>]0",	"@A",	"name=[顕宗];1691.01.11"],
	["[阮福澍]0",	"@A",	"name=[粛宗];1725.04.22"],
	["[阮福闊=ja:%%<阮福濶>]0",	"@A",	"name=[世宗];1738.04.21"],
	...
	["[育徳=ja:%%<育徳帝>]1",	"@A",	"name=[恭宗];1883"],
	["[協和=ja:%%<協和帝>]1",	"@A",	"name=[廃帝];1883"],
	["[建福=ja:%%<建福_(阮朝)>]1",	"@A",	"name=[簡宗];1884"],
	["[咸宜]1",	"@A",	"name=[出帝];1885.01.01"],
	["[同慶=ja:%%<同慶_(阮朝)>]0.10.01","@A",	"name=[敬宗];1885.10.01"],
	["[成泰]1",	"@A", "name=[阮福昭=ja:%%<成泰帝>];1889"],
	["[維新=ja:%%<維新_(阮朝)>]1",	"@A", "name=[阮福晃=ja:%%<維新帝>];1907"],
	["[啓定]1",	"@A",	"name=[弘宗];1916"],
	["[保大=ja:%%<保大_(阮朝)>]1",	"@A", "name=[阮福晪];1926", "1945.09.02=^Gregorian"]
      ]
    ]]
  end
end
