...
module When
  ...
  class TM::CalendarEra
    ...
    # wikipedia 元号一覧 (ベトナム)
    #
    Vietnamese = [{'LY'=>{'DVSK'  => {'A'=>'1120', 'B'=>'1127', 'C'=>'1128', 'D'=>'1133', 'E'=>'1138', 'F'=>'1140', 'G'=>'DVSK'},
                          'VSL'   => {'A'=>'1118', 'B'=>'1125', 'C'=>'1126', 'D'=>'1131', 'E'=>'1136', 'F'=>'1138', 'G'=>'VSL'}},
                   'DN'=>{'KDVNT' => {'H'=>'Chinese1645',   ' I'=>'KDVNT'},
                          'LDN'   => {'H'=>'Vietnamese1813', 'I'=>'LDN'}}}, self, [
      "namespace:[ja=http://ja.wikipedia.org/wiki/, en=http://en.wikipedia.org/wiki/]",
      "locale:[=ja:, en=en:, alias]",
      'area:[ベトナム#{?LY=G}#{&DN=I}=ja:%%<元号>#%.<ベトナム>,Vietnam#{?LY=G}#{&DN=I}=en:Vietnam]',
      [self,
	"period:[前李朝]",
	...
	["[天符睿武]1",	"",		'#{A:1120}'],
	["[天符慶寿]1",	"",		'#{B:1127}'],
	["[天順,alias:大順]1","@A",'name=[神宗];#{C:1128}'],
	["[天彰宝嗣]1",	"",		'#{D:1133}.01.01'],
	["[紹明]1",	"@A",'name=[英宗];#{E:1138}'],
	["[大定]1",	"",		'#{F:1140}.02'],
	["[政隆宝応]1",	"",		    "1163.01.01"],
	["[天感至宝]1",	"",		    "1174.02"],
	...
	["[阮福瀾]1",	"@A",	"name=[神宗];1635"],
	["[阮福瀕]1",	"@A",	"name=[太宗];1649"],
	["[阮福溙]1",	"@A",	"name=[英宗];1688"],
	["[阮福淍]1",	"@A",	"name=[顕宗];1692"],
	["[阮福澍]1",	"@A",	"name=[粛宗];1726"],
	["[阮福闊]1",	"@A",	"name=[世宗];1739"],
	["[阮福淳]1",	"@A",	"name=[睿宗];1766"],
 	["[阮福暎]1",	"@A",	"name=[世祖];1778", "1778"]
      ],
      [self,
	"period:[阮朝,Nguyễn Dynasty=en:Nguy%E1%BB%85n_Dynasty]",
	["[嘉隆]1",	"@F",	"name=[世祖];1802^Vietnamese1631", "1813^Vietnamese1813", ""],
	["[明命]1",	"@A",	"name=[聖祖];1820"],
	["[紹治]1",	"@A",	"name=[憲祖];1841"],
	["[嗣徳]1",	"@A",	"name=[翼宗];1848", '1849^#{H:Chinese1645}', "1850^Vietnamese1813", ""],
	["[育徳]1",	"@A",	"name=[恭宗];1883"],
	["[協和]1",	"@A",	"name=[廃帝];1883"],
	["[建福]1",	"@A",	"name=[簡宗];1884"],
