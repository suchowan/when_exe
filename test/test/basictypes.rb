    ...
    class DateTime < Unit::TestCase
      ...
      def test__x0301_5_2_1
        [                                                     # 5.2.1 暦日付
         ...
         ["+0019850412",             [ 0, "1985-04-12"]],     #  4 a) 拡大表記 特定の日 基本形式
         ["+001985-04-12",           [ 0, "1985-04-12"]],     #  4 a) 拡大表記 特定の日 拡張形式
         ["+001985-04",              [-1, "1985-04"   ]],     #  4 b) 拡大表記 特定の月 基本形式
         ["+001985",                 [-2, "1985"      ]],     #  4 c) 拡大表記 特定の年 基本形式
         ["+0019",                   [-4, "1900"      ]],     #  4 d) 拡大表記 特定の百年代 基本形式
        ].each do |sample|
      ...
      def test__x0301_5_2_2
        [                                                     # 5.2.2 年間通算日
         ...
         ["+001985102",              [ 0, "1985-04-12"]],     #  3 a) 拡大表記 特定の日 基本形式
         ["+001985-102",             [ 0, "1985-04-12"]],     #  3 a) 拡大表記 特定の日 拡張形式
        ].each do |sample|
          date = When.when?(sample[0], {:abbr=>[1985,4,12]})
          assert_equal(sample[1], [date.precision, date.to_s])
        end
      ...
      def test__x0301_5_2_3
        [                                                     # 5.2.3 暦週日付
         ...
         ["+001985W155",             [ 0, "1985-04-12"]],     #  4 a) 拡大表記 特定の日 基本形式
         ["+001985-W15-5",           [ 0, "1985-04-12"]],     #  4 a) 拡大表記 特定の日 拡張形式
         ["+001985W15", [ 0, "1985-04-08...1985-04-15"]],     #  4 b) 拡大表記 特定の週 基本形式
         ["+001985-W15",[ 0, "1985-04-08...1985-04-15"]],     #  4 c) 拡大表記 特定の週 拡張形式
        ].each do |sample|
...
LOCALE
      ...
      def test__label
        assert_equal("Getsuyou", Term2.label)
        assert_equal(String, Term2.label.class)
        assert_equal("Monday", Term3.label)
      end
    end
