...
module Test
  ...
  class Vietnamese < Test::Unit::TestCase
    ...
    Sample = [%w(天符睿武3.1.1                           1122-02-16 天符睿武03(1122).01.01),
              %w(ベトナム?LY=VSL::李朝::天符睿武3.1.1    1120-02-08 ベトナム?LY=VSL::李朝::天符睿武03(1120).01.01),
              %w(嗣徳2.8.1                               1849-09-17 ベトナム::阮朝::嗣徳02(1849).08.01),
              %w(ベトナム?LY=VSL&DN=LDN::阮朝::嗣徳2.8.1 1849-09-16 ベトナム?LY=VSL&DN=LDN::阮朝::嗣徳02(1849).08.01),
    ...
    def test_vietnamese_date
      ...
      When.CalendarEra('Vietnamese?LY=VSL&DN=LDN')
